...
from AppFrontend.Views.bessWriteView import BessRtuWriteView, BessTcpWriteView
...
urlpatterns = [
    ...
    path('api/status/aws/',FormDataAwsService.as_view(),name='get_aws_config'),
    ...
    path("api/bess/rtu/write/", BessRtuWriteView.as_view(), name="bess_rtu_write"),
